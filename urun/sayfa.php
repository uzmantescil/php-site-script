...
$query_detay = sprintf("SELECT * FROM sayfalar WHERE sef = %s", GetSQLValueString($colname_detay, "text"));
...
<html lang="en">
  ...
  <body>
   ...
   <div class="container  bas50">
	   	<div class="alan">
   		<p><img src="upload/sayfalar/<?php echo $row_detay['resim']; ?>" width="300" style="float: left; padding: 5px; border:1px solid #ccc; margin-right: 10px; margin-bottom: 10px; margin-top:15px">
