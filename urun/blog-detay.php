...
$query_detay = sprintf("SELECT * FROM blog WHERE sef = %s", GetSQLValueString($colname_detay, "text"));
...
<html lang="en">
  ...
  <body>
   ...
   <div class="container  bas50">
	   	<div class="alan">
        <img src="upload/blog/<?php echo $row_detay['resim']; ?>" width="100%" style="">
        <hr><b>
        <i class="fa fa-user renk"></i> <?php echo $row_detay['yazar']; ?> / <i class="fa fa-calendar renk" ></i> <?php echo $row_detay['tarih']; ?></b>
        <hr>
   		<p>
