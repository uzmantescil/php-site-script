...
$query_hizmetler = "SELECT * FROM hizmetler where dil = $lang";
...
<html lang="en">
  <head>
    ...
    <title><?php echo $row_dil['hizmetler_title']; ?></title>
    <meta name="description" content="<?php echo $row_dil['hizmetler_desc']; ?>" />
    <meta name="keywords" content="<?php echo $row_dil['hizmetler_keyw']; ?>" />
  ...
  <body>
   ...
   <div class="banner">
   		<div class="text-center">
        	<h1><?php echo $row_dil['hizmetler']; ?></h1>
        </div>
   </div>
