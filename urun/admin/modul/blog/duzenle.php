...
<div class="row">
    <div class="col-lg-12">
        <div class="box box-solid box-primary">
                  ...
                  <div class="box-body">
                     <form id="update" method="post" class="form-horizontal" action="<?=base_admin();?>modul/blog/islemler.php?act=up">
                        ...
                        <div class="col-lg-10">
                          <div class="fileinput fileinput-new" data-provides="fileinput">
                            <div class="fileinput-new thumbnail" style="width: 200px; height: 150px;">
                             <img src="../../../../upload/blog/<?=$data_edit->resim?>">
                            </div>
...
<div class="form-group">
                      ...
                      <input type="hidden" name="id" value="<?=$data_edit->blog_id;?>">
                      <div class="form-group">
