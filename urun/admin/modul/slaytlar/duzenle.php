...
<div class="row">
    <div class="col-lg-12">
        <div class="box box-solid box-primary">
                  ...
                  <div class="box-body">
                     <form id="update" method="post" class="form-horizontal" action="<?=base_admin();?>modul/slaytlar/islemler.php?act=up">
                        ...
                        <div class="col-lg-10">
                          <div class="fileinput fileinput-new" data-provides="fileinput">
                            <div class="fileinput-new thumbnail" style="width: 200px; height: 150px;">
                             <img src="../../../../upload/slaytlar/<?=$data_edit->resim?>">
                            </div>
...
<div class="form-group">
                        ...
                        <div class="col-lg-10">
                          <input type="text" name="alt_baslik" value="<?=$data_edit->alt_baslik;?>" class="form-control" > 
                        </div>
                      </div><!-- /.form-group -->
<div class="form-group">
                        <label for="Buton Başlığı" class="control-label col-lg-2">Buton Başlığı</label>
                        <div class="col-lg-10">
                          <input type="text" name="buton" value="<?=$data_edit->buton;?>" class="form-control" > 
                        </div>
                      </div><!-- /.form-group -->
<div class="form-group">
                      ...
                      <input type="hidden" name="id" value="<?=$data_edit->slayt_id;?>">
                      <div class="form-group">
