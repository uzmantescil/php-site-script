...
<div class="row">
    <div class="col-lg-12">
        <div class="box box-solid box-primary">
                  ...
                  <div class="box-body">
                     <form id="update" method="post" class="form-horizontal" action="<?=base_admin();?>modul/urun_kategorileri/islemler.php?act=up">
...
<div class="form-group">
                        ...
                        <div class="col-lg-10">
                          <input type="text" name="kategori_baslik" value="<?=$data_edit->kategori_baslik;?>" class="form-control" > 
                        </div>
                      </div><!-- /.form-group -->
<div class="form-group">
...
<div class="form-group">
                      ...
                      <input type="hidden" name="id" value="<?=$data_edit->kategori_id;?>">
                      <div class="form-group">
