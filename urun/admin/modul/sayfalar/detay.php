...
<div class="form-group">
      ...
      ?>
      <input name="header" class="make-switch" disabled type="checkbox" checked>
      <?php
    } else {
      ?>
      <input name="header" class="make-switch" disabled type="checkbox">
      <?php
    }?>
                        </div>
                      </div><!-- /.form-group -->
<div class="form-group">
      ...
      ?>
      <input name="footer" class="make-switch" disabled type="checkbox" checked>
      <?php
    } else {
      ?>
      <input name="footer" class="make-switch" disabled type="checkbox">
      <?php
    }?>
                        </div>
                      </div><!-- /.form-group -->
<div class="form-group">
                    ...
                    <img src="../../../../upload/sayfalar/<?=$data_edit->resim?>"></div>
                  </div>
                        </div>
                      </div><!-- /.form-group -->
<div class="form-group">
