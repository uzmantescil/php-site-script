...
<div class="row">
    <div class="col-lg-12"> 
        <div class="box box-solid box-primary">
                  ...
                  <div class="box-body">
                     <form id="input" method="post" class="form-horizontal foto_banyak" action="<?=base_admin();?>modul/sayfalar/islemler.php?act=in">
...
<div class="form-group">
                        ...
                        <div class="col-lg-10">
                          <input type="text" name="baslik" placeholder="Sayfa Adı" class="form-control" > 
                        </div>
                      </div><!-- /.form-group -->
<div class="form-group">
