                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li><a href="<?=base_index();?>sayfalar">Sayfalar</a></li>
...
<div class="row">
    <div class="col-lg-12">
        <div class="box box-solid box-primary">
                  ...
                  <div class="box-body">
                     <form id="update" method="post" class="form-horizontal" action="<?=base_admin();?>modul/sayfalar/islemler.php?act=up">
...
<div class="form-group">
                        <label for="header" class="control-label col-lg-2">Kurumsal'da göster</label>
                        <div class="col-lg-10">
                          <?php if ($data_edit->header=="1") {
      ?>
      <input name="header" class="make-switch" type="checkbox" checked>
      <?php
    } else {
      ?>
      <input name="header" class="make-switch" type="checkbox">
      <?php
    }?>
                        </div>
                      </div><!-- /.form-group -->
<div class="form-group">
                        <label for="footer" class="control-label col-lg-2">Footer'da göster</label>
                        <div class="col-lg-10">
                          <?php if ($data_edit->footer=="1") {
      ?>
      <input name="footer" class="make-switch" type="checkbox" checked>
      <?php
    } else {
      ?>
      <input name="footer" class="make-switch" type="checkbox">
      <?php
    }?>
                        </div>
                      </div><!-- /.form-group -->
                        ...
                        <div class="col-lg-10">
                          <div class="fileinput fileinput-new" data-provides="fileinput">
                            <div class="fileinput-new thumbnail" style="width: 200px; height: 150px;">
                             <img src="../../../../upload/sayfalar/<?=$data_edit->resim?>">
                            </div>
...
<div class="form-group">
                        <label for="Sayfa Adı" class="control-label col-lg-2">Sayfa Adı</label>
                        <div class="col-lg-10">
                          <input type="text" name="baslik" value="<?=$data_edit->baslik;?>" class="form-control" > 
                        </div>
                      </div><!-- /.form-group -->
<div class="form-group">
                        <label for="Sayfa İçeriği" class="control-label col-lg-2">Sayfa İçeriği</label>
                        <div class="col-lg-10">
...
<div class="form-group">
                    ...
                    <a href="<?=base_index();?>sayfalar" class="btn btn-success btn-flat"><i class="fa fa-step-backward"></i> Önceki Sayfa</a>
