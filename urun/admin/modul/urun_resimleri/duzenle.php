...
<div class="row">
    <div class="col-lg-12">
        <div class="box box-solid box-primary">
                  ...
                  <div class="box-body">
                     <form id="update" method="post" class="form-horizontal" action="<?=base_admin();?>modul/urun_resimleri/islemler.php?act=up">
               ...
               <?php foreach ($db->fetch_all("urunler") as $isi) {
                  ...
                  if ($data_edit->urun==$isi->urun_id) {
                    echo "<option value='$isi->urun_id' selected>$isi->baslik</option>";
                  } else {
...
<div class="form-group">
                        ...
                        <div class="col-lg-10">
                          <div class="fileinput fileinput-new" data-provides="fileinput">
                            <div class="fileinput-new thumbnail" style="width: 200px; height: 150px;">
                             <img src="../../../../upload/urun_resimleri/<?=$data_edit->urun_resim?>">
                            </div>
                      ...
                      <input type="hidden" name="id" value="<?=$data_edit->resim_id;?>">
                      <div class="form-group">
