        ...
        <button class="btn btn-default" type="button">Kullanıcı Ara</button>
      </span>
                            <input type="text" name="q" class="form-control" placeholder="Kullanıcı arayın.."/>
                            <span class="input-group-btn">
...
<td><?=$isi->level;?></td>
<td>
<a href="<?=base_index();?>kullanicilar/Duzenle/<?=$isi->id;?>" class="btn btn-primary"><i class="fa fa-pencil"></i></a>
<button class="btn btn-danger hapus" data-uri="<?=base_admin();?>modul/kullanicilar/islemler.php" data-id="<?=$isi->id;?>"><i class="fa fa-trash-o"></i></button>
</td></tr>
        <?php
        $no++;
      }
...
$pg->url=base_index()."user-management?q=".$_GET['q']."&page=";
      ...
      <a href="<?=base_index();?>kullanicilar/Ekle" class="btn btn-primary"><i class="fa fa-plus"></i> Yeni Kullanıcı Ekle</a>
