...
<div class="row">
    <div class="col-lg-12">
        <div class="box box-solid box-primary">
                  ...
                  <div class="box-body">
                     <form id="update" method="post" class="form-horizontal" action="<?=base_admin();?>modul/galeri/islemler.php?act=up">
                        ...
                        <div class="col-lg-10">
                          <div class="fileinput fileinput-new" data-provides="fileinput">
                            <div class="fileinput-new thumbnail" style="width: 200px; height: 150px;">
                             <img src="../../../../upload/galeri/<?=$data_edit->resim?>">
                            </div>
...
<div class="form-group">
      ...
      ?>
      <input name="video" class="make-switch" type="checkbox" checked>
      <?php
    } else {
      ?>
      <input name="video" class="make-switch" type="checkbox">
      <?php
    }?>
                        </div>
                      </div><!-- /.form-group -->
<div class="form-group">
                        ...
                        <div class="col-lg-10">
                          <textarea id="" name="kod" class="form-control"><?=$data_edit->kod;?> </textarea>
                        </div>
                      </div><!-- /.form-group -->

                      <input type="hidden" name="id" value="<?=$data_edit->galeri_id;?>">
                      <div class="form-group">
