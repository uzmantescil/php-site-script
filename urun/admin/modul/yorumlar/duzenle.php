...
<div class="row">
    <div class="col-lg-12">
        <div class="box box-solid box-primary">
                  ...
                  <div class="box-body">
                     <form id="update" method="post" class="form-horizontal" action="<?=base_admin();?>modul/yorumlar/islemler.php?act=up">
                      <div class="form-group">
                        <label for="dil" class="control-label col-lg-2">dil</label>
                        <div class="col-lg-10">
                          <select name="dil" data-placeholder="Pilih dil..." class="form-control chzn-select" tabindex="2" >
               <option value=""></option>
                        ...
                        <div class="col-lg-10">
                          <div class="fileinput fileinput-new" data-provides="fileinput">
                            <div class="fileinput-new thumbnail" style="width: 200px; height: 150px;">
                             <img src="../../../../upload/yorumlar/<?=$data_edit->resim?>">
                            </div>
...
<div class="form-group">
                        <label for="Yazan" class="control-label col-lg-2">Yazan</label>
                        <div class="col-lg-10">
                          <input type="text" name="yazan" value="<?=$data_edit->yazan;?>" class="form-control" > 
                        </div>
                      </div><!-- /.form-group -->
<div class="form-group">
                        <label for="Tarih" class="control-label col-lg-2">Tarih</label>
                        <div class="col-lg-10">
                          <input type="text" id="tgl1" data-rule-date="true" name="tarih" value="<?=$data_edit->tarih;?>" class="form-control" > 
                        </div>
                      </div><!-- /.form-group -->
<div class="form-group">
                      ...
                      <input type="hidden" name="id" value="<?=$data_edit->i_d;?>">
                      <div class="form-group">
                    ...
                    <a href="<?=base_index();?>yorumlar" class="btn btn-success btn-flat"><i class="fa fa-step-backward"></i> Önceki Sayfa</a>
