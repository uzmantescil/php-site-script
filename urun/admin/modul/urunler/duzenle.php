...
<div class="row">
    <div class="col-lg-12">
        <div class="box box-solid box-primary">
                  ...
                  <div class="box-body">
                     <form id="update" method="post" class="form-horizontal" action="<?=base_admin();?>modul/urunler/islemler.php?act=up">
...
<div class="form-group">
                        ...
                        <div class="col-lg-10">
                          <select name="kategori" data-placeholder="Pilih Kategori..." class="form-control chzn-select" tabindex="2" >
               <option value=""></option>
               <?php foreach ($db->fetch_all("urun_kategori") as $isi) {

                  if ($data_edit->kategori==$isi->kategori_id) {
                    echo "<option value='$isi->kategori_id' selected>$isi->kategori_baslik</option>";
                  } else {
                  echo "<option value='$isi->kategori_id'>$isi->kategori_baslik</option>";
                    }
               } ?>
              </select>
                        </div>
                        ...
                        <div class="col-lg-10">
                          <div class="fileinput fileinput-new" data-provides="fileinput">
                            <div class="fileinput-new thumbnail" style="width: 200px; height: 150px;">
                             <img src="../../../../upload/urunler/<?=$data_edit->resim?>">
                            </div>
...
<div class="form-group">
                      ...
                      <input type="hidden" name="id" value="<?=$data_edit->urun_id;?>">
                      <div class="form-group">
