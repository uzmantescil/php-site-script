...
<div class="row">
    <div class="col-lg-12">
        <div class="box box-solid box-primary">
                  ...
                  <div class="box-body">
                     <form id="update" method="post" class="form-horizontal" action="<?=base_admin();?>modul/sosyal_medya/islemler.php?act=up">
...
<div class="form-group">
                        ...
                        <div class="col-lg-10">
                          <input type="text" name="ikon" value="<?=$data_edit->ikon;?>" class="form-control" > 
                        </div>
                      </div><!-- /.form-group -->
<div class="form-group">
