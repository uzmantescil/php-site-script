$(document).ready(function(){
	...
	$("#txtPassword").replaceWith('<input class="m-wrap" id="txtVisible" type="text" value="'+ Save +'" placeholder="Parolanız"/>');
...
$(".seePass").mouseup(function(){
	...
	$("#txtVisible").replaceWith('<input class="m-wrap" id="txtPassword" type="password" value="'+ Save +'"  placeholder="Parolanız"/>');
